...
const OrderDetailsBox = ({ show, setShow }) => {
    return (
        <View className='bg-[#191919] h-[fit] mt-[10] px-[12] rounded-[15px]'>
            <View className='bg-[#392323] my-[15] px-[8] h-[fit] rounded-lg flex flex-row h-[40] justify-between items-center '>
                <View className=' rounded-lg flex flex-row items-center flex-row h-[40]   '>
                    ...
                    <Text style={styles.textFont} className='text-[#D9D9D9] pt-[2.5] px-[8] text-[16px] tracking-wider '>Order Details</Text>
                </View>
                <Svg onPress={setShow}
                    fill="#D9D9D9"
                    width={18}
            ...
            {show && <><View className='px-[10] '>
                <View className='flex flex-row justify-between h-[60] items-center ' style={styles.colorBottomB}>
                    <View className='flex flex-row justify-between '>
                        <View className='rounded-lg px-[8] ' style={styles.colorBorder}>
                            <Text style={styles.textFont} className='text-[#D9D9D9] pt-[2.5] px-[8] text-[14px] tracking-wider '>2x</Text>
                        </View>
                        <Text style={styles.textFont} className='text-[#D9D9D9] pt-[2.5] px-[15] text-[14px] tracking-wider '>Carrot, 500g</Text>
                    </View>
                    <Text style={styles.textFont} className='text-[#D9D9D9] pt-[2.5] px-[8] text-[14px] tracking-wider '>Rs 150</Text>
                </View>
                <View className='flex flex-row justify-between h-[60] items-center ' style={styles.colorBottomB}>
                    <View className='flex flex-row justify-between '>
                        <View className='rounded-lg px-[8] ' style={styles.colorBorder}>
                ...
                <View className='bg-[#392323] px-[10] py-[15] rounded-lg my-[20] '>
                    <View className='flex justify-between flex-row '>
                        <Text style={styles.textFont} className='text-[#D9D9D9] pt-[2.5] px-[8] text-[16px] tracking-wider '>Delivery Charge</Text>
                        <Text style={styles.textFont} className='text-[#D9D9D9] pt-[2.5] px-[8] text-[16px] tracking-wider '>Rs 49</Text>
                    </View>
                    <View className='flex justify-between flex-row mt-[10] mb-[20] '>
                        <Text style={styles.textFont} className='text-[#D9D9D9] pt-[2.5] px-[8] text-[16px] tracking-wider '>Your Commission</Text>
                        <Text style={styles.textFont} className='text-[#D9D9D9] pt-[2.5] px-[8] text-[16px] tracking-wider '>Rs 29</Text>
                    </View>
                    <Divider style={{ backgroundColor: '#787880' }} />
                    <View className='flex justify-between flex-row mt-[20] '>
                        <Text style={styles.textFont} className='text-[#D9D9D9] pt-[2.5] px-[8] text-[16px] tracking-wider '>Total Amount</Text>
                        <Text style={styles.textFont} className='text-[#D9D9D9] pt-[2.5] px-[8] text-[16px] tracking-wider '>Rs 78</Text>
                    </View>
                </View></>}
        </View>
    )
